...
export async function getTousLesCours(params?: { recherche?: string; niveau?: string; page?: number; limit?: number }): Promise<{ page: number; limit: number; total: number; cours: Cours[] }> {
